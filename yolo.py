...
#--------------------------------------------#
# When you use your own model, please remember
# to change two parameters in below which are 
# model_path and classes_path!
# If the shape of data is not approperiate
...
#--------------------------------------------#
# The "classes_path" is the place where the classes of data
# is stored
class YOLO(object):
    _defaults = {
    ...
    def detect_image(self, image):
        ...
        return image,len(out_boxes),predicted_class_all,out_scores
